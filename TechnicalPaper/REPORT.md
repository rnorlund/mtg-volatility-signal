...
**Snapshot 2026-06-04. By Cameraderie Cards. Informational only, not financial advice.**
...
second. It does, at rank correlation **0.463**. The second half is never seen
when the first is computed, so this is genuine out-of-time corroboration, not circular. The fitted
slope is **0.237**, well below 1: volatility is persistent but **mean-reverting**,
...
about **44.0%** (3-month **20.0%**, 6-month **29.4%**).
...
|---|---|---|---|
| Highly volatile | 75-100 | 5,704 | 66.4% |
| Volatile | 50-75 | 9,407 | 32.5% |
| Steady | 25-50 | 9,687 | 21.3% |
| Stable | 0-25 | 5,740 | 8.8% |
...
- This is **version 1: a measured realized-volatility index, not an options-implied or forward
  ...
  mean-reverting (slope 0.237), so the forward bands are estimates, not guarantees.

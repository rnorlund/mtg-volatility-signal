...
**Snapshot 2026-06-01. By Cameraderie Cards. Informational only, not financial advice.**
...
second. It does, at rank correlation **0.439**. The second half is never seen
when the first is computed, so this is genuine out-of-time corroboration, not circular. The fitted
slope is **0.323**, well below 1: volatility is persistent but **mean-reverting**,
...
about **33.1%** (3-month **15.3%**, 6-month **22.4%**).
...
|---|---|---|---|
| Highly volatile | 75-100 | 5,673 | 66.2% |
| Volatile | 50-75 | 9,436 | 32.2% |
| Steady | 25-50 | 9,732 | 21.3% |
| Stable | 0-25 | 5,697 | 9.0% |
...
- This is **version 1: a measured realized-volatility index, not an options-implied or forward
  ...
  mean-reverting (slope 0.323), so the forward bands are estimates, not guarantees.

...
**Snapshot 2026-06-16. By Cameraderie Cards. Informational only, not financial advice.**
...
second. It does, at rank correlation **0.573**. The second half is never seen
when the first is computed, so this is genuine out-of-time corroboration, not circular. The fitted
slope is **0.165**, well below 1: volatility is persistent but **mean-reverting**,
...
about **38.2%** (3-month **17.5%**, 6-month **25.7%**).
...
|---|---|---|---|
| Highly volatile | 75-100 | 5,672 | 66.2% |
| Volatile | 50-75 | 9,412 | 32.1% |
| Steady | 25-50 | 9,694 | 21.3% |
| Stable | 0-25 | 5,760 | 8.8% |
...
- This is **version 1: a measured realized-volatility index, not an options-implied or forward
  ...
  mean-reverting (slope 0.165), so the forward bands are estimates, not guarantees.
